    ...
    <div style={{ minHeight: "100vh", background: "#f1f5fb", fontFamily: "'DM Sans', sans-serif" }}>
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .doctor-row { display: flex; align-items: center; justify-content: space-between; padding: 14px 16px; border-radius: 12px; background: #f8faff; border: 1px solid #e8f0fe; margin-bottom: 10px; transition: box-shadow 0.15s; }
      ...
      {showUpgradePopup && (
        <div style={{ position: "fixed", inset: 0, zIndex: 200, display: "flex", alignItems: "center", justifyContent: "center", padding: 24, background: "rgba(15,23,42,0.3)" }} onClick={() => setShowUpgradePopup(false)}>
          <div className="upgrade-popup" style={{ background: "#fff", borderRadius: 20, padding: "32px", maxWidth: 400, width: "100%", border: `2px solid ${upgradeRequired === "advanced" ? "#1d4ed8" : "#d8b4fe"}`, boxShadow: "0 20px 60px rgba(0,0,0,0.15)", textAlign: "center" }} onClick={e => e.stopPropagation()}>
            ...
            <p style={{ fontSize: "0.88rem", color: "#64748b", marginBottom: 24 }}>
              <strong style={{ color: upgradeRequired === "advanced" ? "#1d4ed8" : "#7c3aed" }}>{upgradeFeature}</strong> requires the {upgradeRequired === "advanced" ? "Advanced" : "Pro"} plan.
            </p>
            <button onClick={() => { setShowUpgradePopup(false); setActiveTab("billing"); }} style={{ width: "100%", background: upgradeRequired === "advanced" ? "linear-gradient(135deg, #0f172a, #1d4ed8)" : "linear-gradient(135deg, #6d28d9, #4f46e5)", color: "#fff", border: "none", padding: "13px", borderRadius: 10, fontWeight: 700, fontSize: "0.95rem", cursor: "pointer", fontFamily: "'DM Sans', sans-serif", marginBottom: 10 }}>
        ...
        <div className="modal-overlay" onClick={() => setShowDoctorModal(false)}>
          <div className="modal" onClick={e => e.stopPropagation()}>
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 20 }}>
              <h2 style={{ fontFamily: "'DM Serif Display', serif", fontSize: "1.2rem", color: "#0f172a" }}>Doctor Profile</h2>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 14, marginBottom: 24, paddingBottom: 20, borderBottom: "1px solid #f1f5f9" }}>
              <div style={{ width: 52, height: 52, background: "#eff6ff", borderRadius: "50%", display: "flex", alignItems: "center", justifyContent: "center", fontWeight: 700, fontSize: "1rem", color: "#1d4ed8" }}>
              ...
              <div>
                ...
                {selectedDoctor.tier === "advanced" && <span style={{ fontSize: "0.7rem", background: "linear-gradient(135deg, #0f172a, #1d4ed8)", color: "#fff", padding: "2px 8px", borderRadius: 100, fontWeight: 700 }}>⚡ Advanced</span>}
            ...
            <div style={{ position: "relative" }}>
              <p style={{ fontSize: "0.78rem", fontWeight: 700, color: "#64748b", textTransform: "uppercase", letterSpacing: "0.06em", marginBottom: 12 }}>
                Full Profile {!isAdvanced && <span style={{ background: "linear-gradient(135deg, #0f172a, #1d4ed8)", color: "#fff", fontSize: "0.65rem", padding: "2px 7px", borderRadius: 100, marginLeft: 6 }}>⚡ ADVANCED</span>}
              </p>
              ...
              {!isAdvanced && (
                <div style={{ position: "absolute", inset: 0, display: "flex", alignItems: "center", justifyContent: "center", cursor: "pointer" }} onClick={() => { setShowDoctorModal(false); handleUpgradeClick("Full Doctor Profile", "advanced"); }}>
                  <div style={{ background: "linear-gradient(135deg, #0f172a, #1d4ed8)", color: "#fff", borderRadius: 12, padding: "10px 20px", fontSize: "0.85rem", fontWeight: 700, boxShadow: "0 4px 20px rgba(29,78,216,0.3)" }}>⚡ Unlock with Advanced</div>
                </div>
              )}
            </div>
      ...
      {showMessageModal && messageDoctor && (
        <div className="modal-overlay" onClick={() => setShowMessageModal(false)}>
          <div className="modal" onClick={e => e.stopPropagation()}>
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 20 }}>
              <h2 style={{ fontFamily: "'DM Serif Display', serif", fontSize: "1.2rem", color: "#0f172a" }}>Message Doctor</h2>
            ...
            <div style={{ marginBottom: 16, padding: "12px 14px", background: "#f8faff", borderRadius: 10, border: "1px solid #e8f0fe" }}>
      ...
      {showVacancyModal && (
        <div className="modal-overlay" onClick={() => setShowVacancyModal(false)}>
          <div className="modal" onClick={e => e.stopPropagation()}>
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 20 }}>
              <h2 style={{ fontFamily: "'DM Serif Display', serif", fontSize: "1.2rem", color: "#0f172a" }}>Post a Spot</h2>
      ...
      <div className="sidebar" style={{ position: "fixed", top: 0, left: 0, width: 240, height: "100vh", background: "#fff", borderRight: "1px solid #e8f0fe", display: "flex", flexDirection: "column", padding: "24px 16px", zIndex: 40, overflowY: "auto" }}>
        ...
        {/* Weekly usage */}
        <div style={{ background: "#f8faff", borderRadius: 12, padding: "12px 14px", marginBottom: 12, border: "1px solid #e8f0fe" }}>
        ...
        {tierBadge ? (
          ...
          <button onClick={() => setActiveTab("billing")} style={{ margin: "0 0 12px", background: "linear-gradient(135deg, #6d28d9, #4f46e5)", border: "none", borderRadius: 12, padding: "12px 14px", cursor: "pointer", textAlign: "left", fontFamily: "'DM Sans', sans-serif" }}>
            <p style={{ fontSize: "0.72rem", color: "rgba(255,255,255,0.7)", marginBottom: 2 }}>You are on</p>
      ...
      <div className="main-content" style={{ marginLeft: 240, padding: "32px 32px 64px" }}>
          ...
          <div>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
              <h1 style={{ fontFamily: "'DM Serif Display', serif", fontSize: "1.6rem", color: "#0f172a" }}>
                {isAdvanced && agency?.is_top_agency && "⚡ "}{agency?.agency_name} 👋
              </h1>
        ...
        {activeTab === "overview" && (
          <div className="fade-up">
            ...
            {isAdvanced && agency?.is_top_agency && (
              <div style={{ background: "linear-gradient(135deg, #0f172a, #1d4ed8)", borderRadius: 14, padding: "16px 20px", marginBottom: 20, display: "flex", alignItems: "center", gap: 12 }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(150px, 1fr))", gap: 16, marginBottom: 24 }}>
              {[
                { label: "Connected Doctors", value: doctors.length, icon: "👨‍⚕️", color: "#eff6ff" },
            ...
            <div className="card" style={{ marginBottom: 20 }}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
                ...
                <div style={{ background: "#eff6ff", borderRadius: 12, padding: "16px" }}>
                  ...
                  <div style={{ display: "flex", alignItems: "baseline", gap: 4 }}>
                    <span style={{ fontSize: "2rem", fontWeight: 700, color: "#1d4ed8" }}>{outreachUsedThisWeek}</span>
                    <span style={{ fontSize: "0.9rem", color: "#94a3b8" }}>/ {outreachLimit === Infinity ? "∞" : outreachLimit}</span>
                  </div>
                  <div style={{ marginTop: 8, background: "#bfdbfe", borderRadius: 100, height: 6, overflow: "hidden" }}>
                    <div style={{ background: "#1d4ed8", height: "100%", width: `${outreachLimit === Infinity ? 0 : Math.min(100, (outreachUsedThisWeek / outreachLimit) * 100)}%`, borderRadius: 100 }} />
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="card">
                ...
                {doctors.length === 0 ? (
                  ...
                  <div key={doc.user_id} style={{ display: "flex", alignItems: "center", gap: 12, padding: "10px 0", borderBottom: "1px solid #f1f5f9" }}>
                    <div style={{ width: 34, height: 34, background: "#eff6ff", borderRadius: "50%", display: "flex", alignItems: "center", justifyContent: "center", fontWeight: 700, fontSize: "0.78rem", color: "#1d4ed8" }}>DR</div>
                    <div>
        ...
        {activeTab === "leads" && (
          <div className="fade-up">
            <div style={{ marginBottom: 20 }}>
              <h2 style={{ fontFamily: "'DM Serif Display', serif", fontSize: "1.3rem", color: "#0f172a" }}>Doctor Leads</h2>
                ...
                {connectionRequests.map(req => (
                  <div key={req.id} style={{ display: "flex", alignItems: "center", justifyContent: "space-between", background: "#fffbeb", border: "1px solid #fde68a", borderRadius: 14, padding: "14px 18px", marginBottom: 10 }}>
                    <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                      ...
                      <div>
                        ...
                        <div style={{ display: "flex", gap: 6, alignItems: "center" }}>
                          ...
                          {req.doctor_tier === "advanced" && <span style={{ fontSize: "0.65rem", background: "linear-gradient(135deg, #0f172a, #1d4ed8)", color: "#fff", padding: "1px 6px", borderRadius: 100, fontWeight: 700 }}>⚡ ADV</span>}
                    ...
                    <div style={{ display: "flex", gap: 8 }}>
                      <button onClick={() => handleAcceptDoctorConnection(req.id)} style={{ background: "#f0fdf4", color: "#16a34a", border: "1.5px solid #bbf7d0", padding: "7px 14px", borderRadius: 10, fontSize: "0.82rem", fontWeight: 600, cursor: "pointer", fontFamily: "'DM Sans', sans-serif" }}>✓ Accept</button>
                      <button onClick={() => handleDeclineDoctorConnection(req.id)} style={{ background: "#fef2f2", color: "#dc2626", border: "1.5px solid #fecaca", padding: "7px 14px", borderRadius: 10, fontSize: "0.82rem", fontWeight: 600, cursor: "pointer", fontFamily: "'DM Sans', sans-serif" }}>✗ Decline</button>
                    </div>
                  </div>
                ))}
              </div>
            ...
            {doctors.length === 0 ? (
              ...
              <div key={doc.user_id} className="doctor-row">
                <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
                  <div style={{ width: 44, height: 44, background: "#eff6ff", borderRadius: "50%", display: "flex", alignItems: "center", justifyContent: "center", fontWeight: 700, fontSize: "0.9rem", color: "#1d4ed8", flexShrink: 0 }}>DR</div>
                  <div>
                    <div style={{ display: "flex", alignItems: "center", gap: 6, marginBottom: 3 }}>
                      ...
                      {doc.tier === "advanced" && <span style={{ fontSize: "0.65rem", background: "linear-gradient(135deg, #0f172a, #1d4ed8)", color: "#fff", padding: "1px 6px", borderRadius: 100, fontWeight: 700 }}>⚡</span>}
                ...
                <div style={{ display: "flex", gap: 8 }}>
                  ...
                  <button onClick={() => handleDisconnectDoctor(doc.user_id)} style={{ background: "#fef2f2", color: "#dc2626", border: "1.5px solid #fecaca", padding: "7px 12px", borderRadius: 10, fontSize: "0.82rem", fontWeight: 600, cursor: "pointer", fontFamily: "'DM Sans', sans-serif" }}>
                    Disconnect
                  </button>
                </div>
              </div>
        ...
        {activeTab === "market" && (
          <div className="fade-up">
            <div style={{ marginBottom: 20 }}>
              <h2 style={{ fontFamily: "'DM Serif Display', serif", fontSize: "1.3rem", color: "#0f172a" }}>Market View</h2>
              <p style={{ fontSize: "0.85rem", color: "#94a3b8", marginTop: 4 }}>
            ...
            {isAdvanced && agency?.is_top_agency && (
              <div style={{ background: "linear-gradient(135deg, #0f172a, #1d4ed8)", borderRadius: 12, padding: "12px 16px", marginBottom: 16, display: "flex", alignItems: "center", gap: 10 }}>
                <span>⚡</span>
            ...
            {marketDoctors.length === 0 ? (
              ...
              <div key={doc.user_id} className="doctor-row" style={{ position: "relative" }}>
                ...
                {(doc.tier === "advanced" || doc.tier === "pro") && i === 0 && (
                  <div style={{ position: "absolute", top: -8, left: 16, fontSize: "0.65rem", fontWeight: 700, background: doc.tier === "advanced" ? "linear-gradient(135deg, #0f172a, #1d4ed8)" : "linear-gradient(135deg, #6d28d9, #4f46e5)", color: "#fff", padding: "2px 8px", borderRadius: 100 }}>
                    {doc.tier === "advanced" ? "⚡ Priority Doctor" : "💎 Pro Doctor"}
                  </div>
                )}
                <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
                  <div style={{ width: 44, height: 44, background: isAdvanced ? "#eff6ff" : "#f1f5f9", borderRadius: "50%", display: "flex", alignItems: "center", justifyContent: "center", fontWeight: 700, fontSize: "0.9rem", color: isAdvanced ? "#1d4ed8" : "#94a3b8", flexShrink: 0, filter: isBase ? "blur(3px)" : "none" }}>
                ...
                <div style={{ display: "flex", gap: 8 }}>
                  {isBase ? (
                    <button style={{ background: "linear-gradient(135deg, #6d28d9, #4f46e5)", color: "#fff", border: "none", padding: "7px 14px", borderRadius: 10, fontSize: "0.82rem", fontWeight: 600, cursor: "pointer", fontFamily: "'DM Sans', sans-serif" }} onClick={() => handleUpgradeClick("Market View & Outreach", "pro")}>
                      💎 Upgrade
                    </button>
                  ) : (
                    <>
        ...
        {activeTab === "vacancies" && (
          <div className="fade-up">
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 20 }}>
              <div>
                <h2 style={{ fontFamily: "'DM Serif Display', serif", fontSize: "1.3rem", color: "#0f172a" }}>Post Spots</h2>
                <p style={{ fontSize: "0.85rem", color: "#94a3b8", marginTop: 4 }}>
            ...
            <div className="card" style={{ marginBottom: 20 }}>
              ...
              <div style={{ display: "flex", gap: 8, marginBottom: 8 }}>
                {Array.from({ length: spotLimit === Infinity ? 5 : spotLimit }).map((_, i) => (
                  <div key={i} style={{ flex: 1, height: 8, borderRadius: 100, background: i < spotsUsedThisWeek ? "#f97316" : "#e8f0fe" }} />
                ))}
                ...
                {vacancies.map(vac => (
                  <div key={vac.id} className="card">
                    <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 12 }}>
                      ...
                      <div style={{ display: "flex", gap: 8 }}>
                        <button onClick={() => handleToggleVacancy(vac.id, vac.active)} style={{ background: "none", border: "none", cursor: "pointer", fontSize: "0.78rem", color: "#94a3b8", fontFamily: "'DM Sans', sans-serif" }}>{vac.active ? "Deactivate" : "Activate"}</button>
                        <button onClick={() => handleDeleteVacancy(vac.id)} style={{ background: "none", border: "none", cursor: "pointer", fontSize: "0.78rem", color: "#dc2626", fontFamily: "'DM Sans', sans-serif" }}>Delete</button>
                      </div>
                    </div>
        ...
        {activeTab === "placed" && (
          <div className="fade-up">
            <div style={{ marginBottom: 20 }}>
              <h2 style={{ fontFamily: "'DM Serif Display', serif", fontSize: "1.3rem", color: "#0f172a" }}>Placed Doctors</h2>
              <p style={{ fontSize: "0.85rem", color: "#94a3b8", marginTop: 4 }}>Doctors successfully placed through MedHub.</p>
            </div>
        ...
        {activeTab === "invoices" && (
          <div className="fade-up">
            <div style={{ marginBottom: 20 }}>
              <h2 style={{ fontFamily: "'DM Serif Display', serif", fontSize: "1.3rem", color: "#0f172a" }}>Invoices</h2>
              <p style={{ fontSize: "0.85rem", color: "#94a3b8", marginTop: 4 }}>Referral fee invoices from MedHub.</p>
            </div>
            <div style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 16, marginBottom: 20 }}>
              {[
                ...
                { label: "Total Earned", value: `£${totalRevenue.toFixed(0)}`, color: "#eff6ff", textColor: "#1d4ed8" },
              ].map((s, i) => (
              ...
              <div className="card">
                ...
                {invoices.map((inv, i) => (
                  <div key={inv.id} style={{ display: "grid", gridTemplateColumns: "2fr 1fr 1fr 1fr", gap: 12, padding: "12px 0", borderBottom: i < invoices.length - 1 ? "1px solid #f1f5f9" : "none", alignItems: "center" }}>
                    ...
                    <span className="status-badge" style={{ background: inv.status === "paid" ? "#f0fdf4" : inv.status === "sent" ? "#eff6ff" : "#fffbeb", color: inv.status === "paid" ? "#16a34a" : inv.status === "sent" ? "#1d4ed8" : "#92400e", display: "inline-block" }}>{inv.status}</span>
                  </div>
                ))}
              </div>
            )}
        ...
        {activeTab === "documents" && (
          <div className="fade-up">
            <div style={{ marginBottom: 20 }}>
              <h2 style={{ fontFamily: "'DM Serif Display', serif", fontSize: "1.3rem", color: "#0f172a" }}>Shared Documents</h2>
              ...
              <div className="card" style={{ padding: 0, overflow: "hidden" }}>
                {shareRequests.map((req, i) => (
                  <div key={req.id} style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "16px 20px", borderBottom: i < shareRequests.length - 1 ? "1px solid #f1f5f9" : "none" }}>
                    <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                      <div style={{ width: 40, height: 40, background: "#eff6ff", borderRadius: 10, display: "flex", alignItems: "center", justifyContent: "center", fontSize: "1.1rem", flexShrink: 0 }}>📄</div>
                      <div>
                    ...
                    <div style={{ display: "flex", gap: 8 }}>
                      ...
                      {req.status === "pending" && (
                        <>
                          <button onClick={() => handleRespondToShare(req.id, "accepted")} style={{ background: "#f0fdf4", color: "#16a34a", border: "1.5px solid #bbf7d0", padding: "6px 14px", borderRadius: 10, fontSize: "0.82rem", fontWeight: 600, cursor: "pointer", fontFamily: "'DM Sans', sans-serif" }}>✓ Accept</button>
                          <button onClick={() => handleRespondToShare(req.id, "declined")} style={{ background: "#fef2f2", color: "#dc2626", border: "1.5px solid #fecaca", padding: "6px 14px", borderRadius: 10, fontSize: "0.82rem", fontWeight: 600, cursor: "pointer", fontFamily: "'DM Sans', sans-serif" }}>✗ Decline</button>
                        </>
                      )}
                    </div>
                  </div>
        ...
        {activeTab === "billing" && (
          <div className="fade-up">
            <div style={{ marginBottom: 24 }}>
              <h2 style={{ fontFamily: "'DM Serif Display', serif", fontSize: "1.3rem", color: "#0f172a" }}>Billing & Subscription</h2>
              <p style={{ fontSize: "0.85rem", color: "#94a3b8", marginTop: 4 }}>Manage your MedHub plan.</p>
            </div>
            <div className="card" style={{ marginBottom: 20 }}>
              <h3 style={{ fontWeight: 700, fontSize: "1rem", color: "#0f172a", marginBottom: 16 }}>Current Plan</h3>
              <div style={{ background: tierBadge ? "linear-gradient(135deg, #fdf4ff, #eff6ff)" : "#f8faff", border: `1.5px solid ${tierBadge ? "#d8b4fe" : "#e8f0fe"}`, borderRadius: 14, padding: "20px 24px" }}>
            ...
            {!isAdvanced && (
              <div style={{ background: "#fff", borderRadius: 20, border: "1px solid #e8f0fe", overflow: "hidden" }}>
                <div style={{ display: "grid", gridTemplateColumns: isBase ? "1fr 1fr" : "1fr", gap: 0 }}>
                  {/* PRO */}
                  {(isBase || isPro) && (
                    <div style={{ borderRight: isBase ? "1px solid #e8f0fe" : "none" }}>
                      <div style={{ background: "linear-gradient(135deg, #6d28d9, #4f46e5)", padding: "24px 28px" }}>
                        <div style={{ fontSize: "1.8rem", marginBottom: 8 }}>💎</div>
                        <h3 style={{ fontFamily: "'DM Serif Display', serif", fontSize: "1.3rem", color: "#fff", marginBottom: 4 }}>Pro</h3>
                      ...
                      <div style={{ padding: "24px 28px" }}>
                        ...
                        <button disabled style={{ width: "100%", background: "linear-gradient(135deg, #6d28d9, #4f46e5)", color: "#fff", border: "none", padding: "12px", borderRadius: 10, fontWeight: 700, fontSize: "0.85rem", cursor: "not-allowed", fontFamily: "'DM Sans', sans-serif", opacity: 0.6 }}>Upgrade to Pro</button>
                      </div>
                    </div>
                  )}
                  ...
                  {/* ADVANCED */}
                  <div>
                    <div style={{ background: "linear-gradient(135deg, #0f172a, #1d4ed8)", padding: "24px 28px" }}>
                      <div style={{ fontSize: "1.8rem", marginBottom: 8 }}>⚡</div>
                      <h3 style={{ fontFamily: "'DM Serif Display', serif", fontSize: "1.3rem", color: "#fff", marginBottom: 4 }}>Advanced</h3>
                    ...
                    <div style={{ padding: "24px 28px" }}>
                      ...
                      <button disabled style={{ width: "100%", background: "linear-gradient(135deg, #0f172a, #1d4ed8)", color: "#fff", border: "none", padding: "12px", borderRadius: 10, fontWeight: 700, fontSize: "0.85rem", cursor: "not-allowed", fontFamily: "'DM Sans', sans-serif", opacity: 0.6 }}>Upgrade to Advanced</button>
                    </div>
                  </div>
                </div>
              </div>
